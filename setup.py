...
check_call(['sudo', 'apt-get', 'install', 'python3-dev', 'python3-setuptools', 'libjpeg-dev', 'zlib1g-dev', 'libpng-dev', 'libfreetype6-dev', '-y'])
check_call(['sudo', 'apt-get', 'install', 'python3-pip', '-y'])
check_call(['sudo', 'apt-get', 'install', 'apache2', '-y'])
check_call(['sudo', 'apt-get', 'install', 'php', 'libapache2-mod-php', '-y'])
...
subprocess.call("(sudo mkdir /var/www/html/Config)", shell=True)
subprocess.call("(sudo mkdir /var/www/html/Config/Lite)", shell=True)
subprocess.call("(sudo mkdir /var/www/html/Config/Lite/Exception)", shell=True)
subprocess.call("(sudo cp -r /home/pi/temp/bin/server/*.* /var/www/html)", shell=True)
subprocess.call("(sudo cp -r /home/pi/temp/bin/server/Config/*.* /var/www/html/Config)", shell=True)
subprocess.call("(sudo cp -r /home/pi/temp/bin/server/Config/Lite/*.* /var/www/html/Config/Lite)", shell=True)
subprocess.call("(sudo cp -r /home/pi/temp/bin/server/Config/Lite/Exception/*.* /var/www/html/Config/Lite/Exception)", shell=True)
...
subprocess.call("(sudo chown -R pi:pi /media/usb0)", shell=True)
